// useFriend hooks — port từ web (src/hooks/useFriend.tsx). Alert thay cho toast.
...
// useFriendSuggestions — gợi ý bạn bè (infinite scroll)
...
// useAllFriends — danh sách bạn bè đã kết nối (infinite scroll)
...
// useAcceptRequest — chấp nhận lời mời (optimistic)
...
// useDeclineRequest — từ chối lời mời (optimistic)
